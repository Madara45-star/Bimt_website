      ...
      class GridContainer extends elementorModules.frontend.handlers.Base {
        ...
        bindEvents() {
          elementorFrontend.elements.$window.on(
            "resize",
            this.onDeviceModeChange.bind(this)
          ),
            elementorFrontend.elements.$window.on(
              "resize",
              this.updateEmptyViewHeight.bind(this)
            ),
        ...
        getCorrectContainer() {
          const e = this.elements.container,
            ...
            {
              selectors: { boxedContainer: i },
            } = t;
          this.elements.outlineParentContainer = e.querySelector(i) || e;
        }
        ...
        createOverlayItems() {
          const { gridOutline: e } = this.elements,
            ...
            { rows: i, columns: n } = this.getDeviceGridDimensions(),
            s = i.length * n.length;
          for (let i = 0; i < s; i++) {
            const i = document.createElement("div");
            i.classList.add(t), e.appendChild(i);
          }
        }
        ...
        setGridOutlineDimensions() {
          const { gridOutline: e } = this.elements,
            { rows: t, columns: i } = this.getDeviceGridDimensions();
          (e.style.gridTemplateColumns = i.value),
            (e.style.gridTemplateRows = t.value);
        }
        getControlValues(e, t, i) {
        ...
        onElementChange(e) {
          this.isControlThatMayAffectEmptyViewHeight(e) &&
            this.updateEmptyViewHeight();
          let t = [
            "grid_rows_grid",
            "grid_columns_grid",
        ...
        getResponsiveControlNames(e) {
          ...
          let i = [];
          for (const n of e) for (const e of t) i.push(`${n}_${e}`);
          return i.push(...e), i;
        }
        onDeviceModeChange() {
          this.initLayoutOverlay();
        ...
        updateEmptyViewHeight() {
          if (this.shouldUpdateEmptyViewHeight()) {
            const { emptyView: e } = this.elements,
              ...
              n =
                "desktop" === t ? i.grid_rows_grid : i.grid_rows_grid + "_" + t;
            e?.style.removeProperty("min-height"),
              this.hasCustomUnit(n) &&
                this.isNotOnlyANumber(n) &&
                this.sizeNotEmpty(n) &&
        ...
        shouldUpdateEmptyViewHeight() {
          return !!this.elements.container.querySelector(
    ...
    343: (e, t) => {
      ...
      class Shapes extends elementorModules.frontend.handlers.Base {
        ...
        getSvgURL(e, t) {
          ...
          return (
            elementor.config.additional_shapes &&
              ...
              ((i = elementor.config.additional_shapes[e]),
              -1 < t.indexOf("-negative") &&
                (i = i.replace(".svg", "-negative.svg"))),
            i
          );
        }
        buildSVG(e) {
        ...
        onElementChange(e) {
          ...
          const i = e.match(/^shape_divider_(top|bottom)_negative$/);
