var ddbeforeandafter = (function ($) {
  ...
  function ddbeforeandafter(options) {
    ...
    $dragbar.bind("mousedown touchstart", function (e) {
      ...
      var e =
        e.type.indexOf("touch") != -1 ? e.originalEvent.changedTouches[0] : e;
  ...
  ddbeforeandafter.prototype = {
    ...
    _init: function (initoptions) {
      ...
      if ($beforeimage.prop("complete") === true) imagesloadeddfd[0].resolve();
      if ($afterimage.prop("complete") === true) imagesloadeddfd[1].resolve();
